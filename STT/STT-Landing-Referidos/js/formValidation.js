...
function sendToEplat () {
  ...
  const IDreferral = window.location.search;
  console.log(IDreferral);
  //Creamos la instancia
  const urlParams = new URLSearchParams(IDreferral);
  //Acceso a los valores 
  var ID = urlParams.get('IDreferral');

  console.log(urlParams.has('IDreferral'));
  ...
  var data = JSON.stringify({"webhookID": "fb7d9215-1a18-920d-f7bf-539eee144131", "firstName": fname.value, "lastName": lname.value, "phone": phone.value, "email": email.value, "IDreferrer":urlParams,  "timeToReach": timeToReach.value});
  var xhr = new XMLHttpRequest();
  var url = "https://developers.eplat.com/api/webhooks/incoming/genericjson/newreferral?code=52f2aba8f603473eafb5df370e02d169";
